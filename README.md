...
3. Open the application:
   Open `index.html` directly in your browser, or serve it using a local development server like VS Code's Live Server extension.

---

## 💡 Usage

1. Add a Task: Type your task into the input box and press Enter or click Add Task.

2. Mark Complete: Click on the checkbox or completion toggle next to the task item.

3. Delete Task: Click the delete/trash icon to clear tasks you no longer need.
